...
module.exports = {
    ...
    let button2 = new MessageButton()
      .setStyle('blurple')
      .setLabel('Little Big Planet') 
      .setID('r13answer') 
      .setDisabled()

    let button3 = new MessageButton()
      .setStyle('green')
      .setLabel('Spyro Reignited Trilogy') 
      .setID('null2') 
      .setDisabled()

    let button4 = new MessageButton()
      .setStyle('grey')
      .setLabel('Yoshi\'s Woolly World') 
      .setID('null3')  
      .setDisabled()
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 13*`)
        .setThumbnail(`https://imgur.com/q6T8ytM.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r13answer')


      const filter = (button, user) => button.id === 'r13answer' && !user.bot;
