...
module.exports = {
    ...
    let button2 = new MessageButton()
      .setStyle('blurple')
      .setLabel('Mario Kart Wii') 
      .setID('r33answer') 
      .setDisabled()

    let button3 = new MessageButton()
      .setStyle('green')
      .setLabel('1080° Avalanche') 
      .setID('null2') 
      .setDisabled()

    let button4 = new MessageButton()
      .setStyle('grey')
      .setLabel('Donkey Kong Country') 
      .setID('null3')                        
      .setDisabled()
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 33*`)
        .setThumbnail(`https://imgur.com/K4oRQpB.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r33answer')


      const filter = (button, user) => button.id === 'r33answer' && !user.bot;
