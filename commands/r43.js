...
module.exports = {
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 43*`)
        .setThumbnail(`https://imgur.com/heRtBz1.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r43answer')


      const filter = (button, user) => button.id === 'r43answer' && !user.bot;
