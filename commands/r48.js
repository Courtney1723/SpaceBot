...
module.exports = {
    ...
    let button4 = new MessageButton()
      .setStyle('grey')
      .setLabel('Croc: Legend of the Gobbos') 
      .setID('r48answer')            
      .setDisabled()
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 48*`)
        .setThumbnail(`https://i.imgur.com/9YZCJWW.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r48answer')


      const filter = (button, user) => button.id === 'r48answer' && !user.bot;
