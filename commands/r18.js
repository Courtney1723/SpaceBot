...
module.exports = {
    ...
    let button1 = new MessageButton()
      .setStyle('red')
      .setLabel('Super Mario 64') 
      .setID('null1') 
      .setDisabled()

    let button2 = new MessageButton()
      .setStyle('blurple')
      .setLabel('Perfect Dark') 
      .setID('null2') 
      .setDisabled()

    let button3 = new MessageButton()
      .setStyle('green')
      .setLabel('The World Is Not Enough') 
      .setID('null3') 
      .setDisabled()

    let button4 = new MessageButton()
      .setStyle('grey')
      .setLabel('GoldenEye 007') 
      .setID('r18answer')              
      .setDisabled()
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 18*`)
        .setThumbnail(`https://imgur.com/9fLt6cP.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r18answer')


      const filter = (button, user) => button.id === 'r18answer' && !user.bot;
