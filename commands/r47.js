...
module.exports = {
    ...
    let button3 = new MessageButton()
      .setStyle('green')
      .setLabel('Plants vs. Zombies') 
      .setID('r47answer') 
      .setDisabled()

    let button4 = new MessageButton()
      .setStyle('grey')
      .setLabel('Temple Run 2') 
      .setID('null3')          
      .setDisabled()
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 47*`)
        .setThumbnail(`https://imgur.com/2idUFuv.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r47answer')


      const filter = (button, user) => button.id === 'r47answer' && !user.bot;
