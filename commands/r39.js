...
module.exports = {
    ...
    let button1 = new MessageButton()
      .setStyle('red')
      .setLabel('Life is Strange') 
      .setID('r39answer') 
      .setDisabled()

    let button2 = new MessageButton()
      .setStyle('blurple')
      .setLabel('Detroit: Become Human') 
      .setID('null1') 
      .setDisabled()
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 39*`)
        .setThumbnail(`https://imgur.com/er2TrOC.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r39answer')


      const filter = (button, user) => button.id === 'r39answer' && !user.bot;
