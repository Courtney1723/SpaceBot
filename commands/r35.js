...
module.exports = {
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 35*`)
        .setThumbnail(`https://imgur.com/2Bu3c80.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r35answer')


      const filter = (button, user) => button.id === 'r35answer' && !user.bot;
