...
module.exports = {
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 24*`)
         .setThumbnail(`https://imgur.com/ykiuoy2.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r24answer')


      const filter = (button, user) => button.id === 'r24answer' && !user.bot;
