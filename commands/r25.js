...
module.exports = {
    ...
    let button2 = new MessageButton()
      .setStyle('blurple')
      .setLabel('Persona 5 Strikers') 
      .setID('null2') 
      .setDisabled()

    let button3 = new MessageButton()
      .setStyle('green')
      .setLabel('Monster Hunter Stories 2: Wings Of Ruin') 
      .setID('null3') 
      .setDisabled()

    let button4 = new MessageButton()
      .setStyle('grey')
      .setLabel('Dragon Quest III: The Seeds of Salvation') 
      .setID('r25answer')    
      .setDisabled()
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 25*`)
        .setThumbnail(`https://imgur.com/uJPXG0E.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r25answer')


      const filter = (button, user) => button.id === 'r25answer' && !user.bot;
