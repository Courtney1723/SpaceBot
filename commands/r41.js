...
module.exports = {
    ...
    let button1 = new MessageButton()
      .setStyle('red')
      .setLabel('Mortal Combat Trilogy') 
      .setID('null1') 
      .setDisabled()
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 41*`)
        .setThumbnail(`https://imgur.com/9961E9b.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r41answer')


      const filter = (button, user) => button.id === 'r41answer' && !user.bot;
