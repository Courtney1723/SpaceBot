...
module.exports = {
    ...
    let button3 = new MessageButton()
      .setStyle('green')
      .setLabel('Disney\'s Magical World') 
      .setID('null2') 
      .setDisabled()

    let button4 = new MessageButton()
      .setStyle('grey')
      .setLabel('LEGO Island 2') 
      .setID('null3')          
      .setDisabled()
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 9*`)
         .setThumbnail(`https://imgur.com/FRUR0zP.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r09answer')


      const filter = (button, user) => button.id === 'r09answer' && !user.bot;
