...
module.exports = {
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 28*`)
        .setThumbnail(`https://imgur.com/kN1HwMG.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r28answer')


      const filter = (button, user) => button.id === 'r28answer' && !user.bot;
