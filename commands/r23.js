...
module.exports = {
    ...
    let button1 = new MessageButton()
      .setStyle('red')
      .setLabel('Paper Mario: The Thousnd Year Door') 
      .setID('null1') 
      .setDisabled()

    let button2 = new MessageButton()
      .setStyle('blurple')
      .setLabel('Super Mario 3D Land') 
      .setID('null2') 
      .setDisabled()

    let button3 = new MessageButton()
      .setStyle('green')
      .setLabel('Super Mario Sunshine') 
      .setID('r23answer') 
      .setDisabled()

    let button4 = new MessageButton()
      .setStyle('grey')
      .setLabel('Mario Kart 64') 
      .setID('null3')                         
      .setDisabled()
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 23*`)
        .setThumbnail(`https://imgur.com/2JzP41z.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r23answer')


      const filter = (button, user) => button.id === 'r23answer' && !user.bot;
