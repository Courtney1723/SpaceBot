...
module.exports = {
    ...
    let button1 = new MessageButton()
      .setStyle('red')
      .setLabel('Dance Dance Revoluton') 
      .setID('null1') 
      .setDisabled()
    ...
    let button3 = new MessageButton()
      .setStyle('green')
      .setLabel('Kinect Adventures!') 
      .setID('r37answer') 
      .setDisabled()

    let button4 = new MessageButton()
      .setStyle('grey')
      .setLabel('Golden Sun: Dark Dawn') 
      .setID('null3')         
      .setDisabled()
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 37*`)
        .setThumbnail(`https://imgur.com/q7rIfw0.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r37answer')


      const filter = (button, user) => button.id === 'r37answer' && !user.bot;
