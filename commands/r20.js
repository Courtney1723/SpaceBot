...
module.exports = {
    ...
    let button1 = new MessageButton()
      .setStyle('red')
      .setLabel('Ori and the Blind Forest') 
      .setID('r20answer') 
      .setDisabled()
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 20*`)
        .setThumbnail(`https://imgur.com/BnIWecO.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r20answer')


      const filter = (button, user) => button.id === 'r20answer' && !user.bot;
