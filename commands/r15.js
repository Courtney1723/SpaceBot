...
module.exports = {
    ...
    let button1 = new MessageButton()
      .setStyle('red')
      .setLabel('Yooka-Laylee') 
      .setID('r15answer') 
      .setDisabled()

    let button2 = new MessageButton()
      .setStyle('blurple')
      .setLabel('Banjo Kazooie') 
      .setID('null1') 
      .setDisabled()
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 15*`)
        .setThumbnail(`https://imgur.com/3uyy396.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r15answer')


      const filter = (button, user) => button.id === 'r15answer' && !user.bot;
