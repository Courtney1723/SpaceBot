...
module.exports = {
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 36*`)
        .setThumbnail(`https://imgur.com/N5L61YO.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r36answer')


      const filter = (button, user) => button.id === 'r36answer' && !user.bot;
