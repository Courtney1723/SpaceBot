...
module.exports = {
    ...
    let button4 = new MessageButton()
      .setStyle('grey')
      .setLabel('Teenage Mutant Ninja Turtles') 
      .setID('r38answer')            
      .setDisabled()
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 38*`)
        .setThumbnail(`https://imgur.com/9LI4PG8.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r38answer')


      const filter = (button, user) => button.id === 'r38answer' && !user.bot;
