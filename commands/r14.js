...
module.exports = {
    ...
    let button1 = new MessageButton()
      .setStyle('red')
      .setLabel('Crash Bandicoot 4: It’s About Time') 
      .setID('null1') 
      .setDisabled()

    let button2 = new MessageButton()
      .setStyle('blurple')
      .setLabel('SpongeBob SquarePants: Battle for Bikini Bottom') 
      .setID('null2') 
      .setDisabled()

    let button3 = new MessageButton()
      .setStyle('green')
      .setLabel('Ratchet & Clank') 
      .setID('r14answer') 
      .setDisabled()

    let button4 = new MessageButton()
      .setStyle('grey')
      .setLabel('Ape Escape 3') 
      .setID('null3')   
      .setDisabled()
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 14*`)
        .setThumbnail(`https://imgur.com/tPskPr6.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r14answer')


      const filter = (button, user) => button.id === 'r14answer' && !user.bot;
