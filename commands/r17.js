...
module.exports = {
    ...
    let button1 = new MessageButton()
      .setStyle('red')
      .setLabel('Shadow Warrior') 
      .setID('null1') 
      .setDisabled()

    let button2 = new MessageButton()
      .setStyle('blurple')
      .setLabel('Duke Nukem Forever') 
      .setID('r17answer') 
      .setDisabled()
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 17*`)
        .setThumbnail(`https://imgur.com/QT908Iw.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r17answer')


      const filter = (button, user) => button.id === 'r17answer' && !user.bot;
