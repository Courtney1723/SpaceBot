...
module.exports = {
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 44*`)
        .setThumbnail(`https://imgur.com/Nb9od2i.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r44answer')


      const filter = (button, user) => button.id === 'r44answer' && !user.bot;
