...
module.exports = {
    ...
    let button2 = new MessageButton()
      .setStyle('blurple')
      .setLabel('COD: Black Ops Cold War') 
      .setID('null2') 
      .setDisabled()
    ...
    let button4 = new MessageButton()
      .setStyle('grey')
      .setLabel('Star Wars Battlefront II') 
      .setID('null3')     
      .setDisabled()
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 4*`)
        .setThumbnail(`https://imgur.com/XdfODdu.png`) 
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r04answer')


      const filter = (button, user) => button.id === 'r04answer' && !user.bot;
