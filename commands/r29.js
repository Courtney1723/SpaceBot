...
module.exports = {
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 29*`)
        .setThumbnail(`https://imgur.com/mTo6sCl.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r29answer')


      const filter = (button, user) => button.id === 'r29answer' && !user.bot;
