...
module.exports = {
    ...
    let button2 = new MessageButton()
      .setStyle('blurple')
      .setLabel('Sea of Solitude') 
      .setID('null2') 
      .setDisabled()

    let button3 = new MessageButton()
      .setStyle('green')
      .setLabel('Little Nightmares II') 
      .setID('null3') 
      .setDisabled()
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 30*`)
        .setThumbnail(`https://imgur.com/yVgHnLv.png`)
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r30answer')


      const filter = (button, user) => button.id === 'r30answer' && !user.bot;
