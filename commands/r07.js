...
module.exports = {
    ...
    let embed1 = new MessageEmbed()
        .setColor('#B75AFF')
        .setDescription(`*Round 7*`)
         .setThumbnail(`https://imgur.com/zzoRBfx.png`) 
...
message.channel.send({
  ...
  embed: embed2})).catch(err => console.log(err))
    ...
    .then((async function (message, button) {
      ...
      await (message => message.button.id == 'r07answer')


      const filter = (button, user) => button.id === 'r07answer' && !user.bot;
